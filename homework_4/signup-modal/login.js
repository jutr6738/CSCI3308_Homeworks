function openModal() {
	...
	myInput.onkeyup = function() {
       console.log('helllooo')
        ...
        if(myInput.value.match(lowerCaseLetters)) {             
            ...
            letter.classList.remove("invalid:before"); 
        ...
        if(myInput.value.match(upperCaseLetters)) { 
            ...
            capital.classList.remove("invalid:beffore");
        ...
        if(myInput.value.match(numbers)) { 
            ...
            number.classList.remove("invalid:before"); 
        ...
        if(myInput.value.length >= minLength) {
            ...
            length.classList.remove("invalid:before");
    ...
    confirmMyInput.onkeyup = function() {
                ...
                if(passEqualsConfPass) { 
                    ...
                    match.classList.remove("invalid:before"); 
...
function enableButton(letter, capital, number, length, match) {
    ...
    var condition = (document.getElementsByClassName("invalid").length == 0); // TODO: Replace false with the correct condition
    if(condition) {       
